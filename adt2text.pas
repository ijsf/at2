...
const
  ...
  help_data: array[1..LINES] of String[128] = (
    ...
    'รฤฤฤฤฤฤฤฤฤฤฤฤฤฤยฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤด',
    'ณ ~^Left,^Right~ ณ Select group of tracks for recording            ณ',
    'ณ ~Space~        ณ Start recording from current position using     ณ',
    'ณ              ณ present instruments in tracks                   ณ',
    'ณ ~MBoard keys~  ณ `1) When recording is armed:`                     ณ',
    'ณ              ณ    Permanently set current instrument for all   ณ',
    'ณ              ณ    tracks and start recording with given notes  ณ',
    'ณ              ณ `2) When recording is started:`                   ณ',
    'ณ              ณ    Write notes to corresponding tracks          ณ',
    ...
    'ณ ~F8,F9~        ณ Toggle pattern repeat OFF/ON while recording    ณ',
    ...
    'รฤฤฤฤฤฤฤฤฤฤฤฤฤฤมฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤด',
    'ณ In case you need non-continuos track selection, you can choose ณ',
    'ณ from already selected group a subset of tracks where notes     ณ',
    'ณ will be written by manipulating track ON/OFF flags.            ณ',
