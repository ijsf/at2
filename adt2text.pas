...
const
  ...
  ascii_line_23 = 'ณ `special thanks:`                                      ณ';
  ascii_line_24 = 'ณ ~encore~                HOMEPAGE  www.adlibtracker.net ณ';
  ascii_line_25 = 'ณ ~insane/Altair~         EMAiL     subz3ro@hotmail.com  ณ';
...
const
  ...
  help_data: array[1..LINES] of String[128] = (
    ...
    '@@`xx ฤฤ SET CUSTOM SPEED TABLE     xx=strength_value       [0=Default,1-FF]',
    '',
    '',
