...
const
  ...
  MAX_COLUMNS: Byte = 90;
  MAX_ROWS: Byte = 40;
  MAX_TRACKS: Byte = 5; export name 'TC__TXTSCRIO____MAX_TRACKS';
...
const
  ...
  SCREEN_MEM_SIZE: Longint = MAX_SCREEN_MEM_SIZE; export name 'TC__TXTSCRIO____SCREEN_MEM_SIZE';
...
var
  ...
  temp_screen2:         tSCREEN_MEM; export name 'U__TXTSCRIO____TEMP_SCREEN2';
...
const
  screen_ptr:          Pointer = Addr(text_screen_shadow); export name 'TC__TXTSCRIO____SCREEN_PTR';
  ptr_temp_screen:     Pointer = Addr(temp_screen);
  ptr_temp_screen2:    Pointer = Addr(temp_screen2); export name 'TC__TXTSCRIO____PTR_TEMP_SCREEN2';
...
const
  move_to_screen_data: Pointer = NIL; export name 'TC__TXTSCRIO____MOVE_TO_SCREEN_DATA';
  move_to_screen_area: array[1..4] of Byte = (0,0,0,0); export name 'TC__TXTSCRIO____MOVE_TO_SCREEN_AREA';
...
const
  MaxLn: Byte = 0; export name 'TC__TXTSCRIO____MAXLN';
  MaxCol: Byte = 0; export name 'TC__TXTSCRIO____MAXCOL';
  hard_maxcol: Byte = 0;
  hard_maxln:  Byte = 0;
  work_maxcol: Byte = 0;
  work_maxln:  Byte = 0;
...
const
  area_x1: Byte = 0; export name 'TC__TXTSCRIO____AREA_X1';
  area_y1: Byte = 0; export name 'TC__TXTSCRIO____AREA_Y1';
  area_x2: Byte = 0; export name 'TC__TXTSCRIO____AREA_X2';
  area_y2: Byte = 0; export name 'TC__TXTSCRIO____AREA_Y2';
