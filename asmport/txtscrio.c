...
char TXTSCRIO____SHOW_STR_BYTE_BYTE_SHORTSTRING_BYTE(char a1, unsigned char *a2, unsigned char a3, char a4)
{
  ...
  FPC_SHORTSTR_TO_SHORTSTR(&v10, 0xFFu, a2);
  HIWORD(v4) = 0;
...
char TXTSCRIO____SHOW_CSTR_BYTE_BYTE_SHORTSTRING_BYTE_BYTE(char a1, char a2, unsigned char *a3, unsigned char a4, char a5)
{
  ...
  v7 = FPC_SHORTSTR_TO_SHORTSTR(&v17, 0xFFu, a3);
  v20 = a2;
  v19 = a1;
  HIWORD(v5) = 0;
...
long long TXTSCRIO____DUPCHAR(long long a1, int a2, int a3)
{
  __int16 v3; // bx@1
  char v4; // t1^1@1
  _WORD *v5; // edi@2
...
char TXTSCRIO____SHOWSTR_TSCREEN_MEM_PTR_BYTE_BYTE_SHORTSTRING_BYTE(char a1, unsigned char *a2, char a3, char a4, int a5)
{
  ...
  LODWORD(v5) = FPC_SHORTSTR_TO_SHORTSTR(&v12, 0xFFu, a2);
  LOBYTE(v5) = a4;
  BYTE1(v5) = a3;
...
char TXTSCRIO____SHOWVSTR_TSCREEN_MEM_PTR_BYTE_BYTE_SHORTSTRING_BYTE(char a1, unsigned char *a2, char a3, char a4, int a5)
{
  ...
  char *v10; // edi@2
  __int16 v11; // ax@2
  char v13; // [sp+Ch] [bp-100h]@1
  _BYTE v14[3]; // [sp+Dh] [bp-FFh]@1

  LODWORD(v5) = FPC_SHORTSTR_TO_SHORTSTR(&v13, 0xFFu, a2);
...
char TXTSCRIO____SHOWCSTR_TSCREEN_MEM_PTR_BYTE_BYTE_SHORTSTRING_BYTE_BYTE(char a1, char a2, unsigned char *a3, char a4, char a5, int a6)
{
  ...
  char v11; // bh@2
  char v12; // t0@6
  unsigned __int8 v14; // [sp+Ch] [bp-100h]@1
  _BYTE v15[3]; // [sp+Dh] [bp-FFh]@1

  LODWORD(v6) = FPC_SHORTSTR_TO_SHORTSTR(&v14, 0xFFu, a3);
  LOBYTE(v6) = v14;
  v7 = v15;
  if ( v14 )
  {
...
char TXTSCRIO____SHOWVCSTR_TSCREEN_MEM_PTR_BYTE_BYTE_SHORTSTRING_BYTE_BYTE(char a1, char a2, unsigned char *a3, char a4, char a5, int a6)
{
  ...
  char v12; // bh@2
  char v13; // t0@6
  unsigned __int8 v15; // [sp+Ch] [bp-100h]@1
  _BYTE v16[3]; // [sp+Dh] [bp-FFh]@1

  LODWORD(v7) = FPC_SHORTSTR_TO_SHORTSTR(&v15, 0xFFu, a3);
...
char TXTSCRIO____SHOWC3STR_TSCREEN_MEM_PTR_BYTE_BYTE_SHORTSTRING_BYTE_BYTE_BYTE(char a1, char a2, char a3, unsigned char *a4, char a5, char a6, int a7)
{
  ...
  char v14; // t0@7
  char v15; // t1@9
  unsigned __int8 v17; // [sp+Ch] [bp-100h]@1
  _BYTE v18[3]; // [sp+Dh] [bp-FFh]@1

  LODWORD(v7) = FPC_SHORTSTR_TO_SHORTSTR(&v17, 0xFFu, a4);
  LOBYTE(v7) = v17;
  v8 = v18;
  if ( v17 )
  {
...
char TXTSCRIO____SHOWC4STR_TSCREEN_MEM_PTR_BYTE_BYTE_SHORTSTRING_BYTE_BYTE_BYTE_BYTE(char a1, char a2, char a3, char a4, unsigned char *a5, char a6, char a7, int a8)
{
  ...
  LODWORD(v8) = FPC_SHORTSTR_TO_SHORTSTR(&v19, 0xFFu, a5);
  LOBYTE(v8) = v19;
  v9 = v20;
  if ( v19 )
  {
...
char TXTSCRIO____SHOWVC3STR_TSCREEN_MEM_PTR_BYTE_BYTE_SHORTSTRING_BYTE_BYTE_BYTE(char a1, char a2, char a3, unsigned char *a4, char a5, char a6, int a7)
{
  ...
  char v15; // t0@7
  char v16; // t1@9
  unsigned __int8 v18; // [sp+Ch] [bp-100h]@1
  _BYTE v19[3]; // [sp+Dh] [bp-FFh]@1

  LODWORD(v8) = FPC_SHORTSTR_TO_SHORTSTR(&v18, 0xFFu, a4);
...
char TXTSCRIO____CSTRLEN_SHORTSTRING__BYTE(unsigned char *a1)
{
  ...
  int v3; // ecx@1
  char v4; // al@2
  unsigned __int8 v6; // [sp+Ch] [bp-108h]@1
  _BYTE v7[3]; // [sp+Dh] [bp-107h]@1

  FPC_SHORTSTR_TO_SHORTSTR(&v6, 0xFFu, a1);
  v1 = v7;
  v2 = 0;
  v3 = v6;
  if ( v6 )
...
char TXTSCRIO____FRAME_crc0EA7F576(unsigned char *a1, char a2, unsigned char *a3, char a4, char a5, char a6, char a7, char a8, int a9)
{
  ...
  FPC_SHORTSTR_TO_SHORTSTR(&v47, 0xFFu, a3);
  LODWORD(v9) = FPC_SHORTSTR_TO_SHORTSTR(&v38, 0xFFu, a1);
  ...
  if ( v28 )
  {
    LODWORD(v27) = (unsigned __int8)(a6 - a8 - v47);
    LOBYTE(v27) = (unsigned __int8)(a6 - a8 - v47) % 2u + a8 + (unsigned __int8)(a6 - a8 - v47) / 2u;
    BYTE1(v27) = a7;
  ...
  if ( v10 )
  {
    ...
    do
    {
      ...
      LOBYTE(v27) = v54 + a6;
      BYTE1(v27) = v31;
      v27 = TXTSCRIO____DUPCHAR(v27, 0, (int)v11);
    ...
    LOBYTE(v27) = v53 + a8;
    BYTE1(v27) = v50 + a5;
    v34 = TXTSCRIO____DUPCHAR(v27, 0, (int)v11);
  ...
  if ( TC__TXTSCRIO____MOVE_TO_SCREEN_DATA )
  {
    ...
    do
    {
      ...
      do
      {
        ...
        LOBYTE(v0) = v4;
        BYTE1(v0) = v7;
        v0 = TXTSCRIO____DUPCHAR(v0, 0, (int)v2);
